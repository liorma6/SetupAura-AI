        ...
        <ScreenContainer>
            <div className="flex-1 overflow-y-auto pb-28">
                <header className="mb-6">
                    <h2 className="text-xl font-display font-extrabold tracking-wide text-white">STEP 2: CUSTOMIZE YOUR THEME</h2>
                    <p className="text-gray-400 text-sm mt-1">Choose an aesthetic style for your dream gaming room</p>
                </header>
                    ...
                    {normalizedThemes.map((theme) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                />
                                <div className={`absolute inset-0 bg-gradient-to-t ${theme.tint}`} />
            ...
            <div className="fixed bottom-0 left-0 right-0 p-4 bg-background/95 backdrop-blur-xl border-t border-white/10 z-[60] max-w-[480px] mx-auto">
                <Button variant="primary" onClick={handleNext} className="w-full py-3.5 text-base font-extrabold tracking-wide shadow-lg shadow-primary/30">
