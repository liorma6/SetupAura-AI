...
export const RecommendationsScreen = () => {
        ...
        return (
            <div className="min-h-screen bg-[#0a0a0a] text-white flex flex-col items-center justify-center p-6 text-center">
                ...
                <div className="flex items-center gap-3 text-sm text-gray-500">
                    ...
                    <span>·</span>
                    <button onClick={() => { setPendingEmail(''); setFlow('email'); setOtpError(''); }} className="hover:text-white transition-colors">
                        Change Email
                    </button>
                </div>
            </div>
    ...
    return (
        <div className="min-h-screen bg-[#0a0a0a] text-white flex flex-col items-center justify-center p-6 text-center">
            ...
            <p className="text-gray-400 mb-8">Enter your email to generate your design.</p>
            <form onSubmit={handleEmailSubmit} className="w-full max-w-sm space-y-4">
                ...
                />
                {(otpError || error) && <p className="text-red-400 text-sm">{otpError || error}</p>}
