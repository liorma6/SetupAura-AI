    ...
    try {
        ...
        const aiResponse = await Promise.race([
            openai.images.edit({
                model: 'gpt-image-1',
                image: imageFile,
                prompt: `You are an expert interior design photographer specializing in gaming setups. Your task is to edit this real room photo into the ultimate ${activeTheme}. STRICT RULES: (1) Extremely photorealistic interior design photography, 8K resolution quality. This must be completely indistinguishable from a real photograph — NOT a 3D render, NOT digital art, NOT a cartoon or illustration. (2) STRICTLY MAINTAIN the exact original room layout: keep all walls, windows, doors, ceiling, floor, and large furniture placement exactly as they appear. Do NOT alter the room's architecture or perspective. (3) Make the room look deeply lived-in and highly personalized. Naturally populate shelves, walls, and desk surfaces with realistic gaming accessories: action figures, collectibles, console controllers, premium PC hardware, mechanical keyboards, headphone stands, and game cases. (4) Where possible, preserve small existing objects and decorations from the original photo, but seamlessly upgrade their aesthetic to match the ${activeTheme} theme. (5) Use natural, balanced ambient RGB lighting — subtle LED strips along desk edges and behind monitors, warm accent lights. Avoid washing the entire room in a single blinding neon color. Keep lighting authentic and inviting, with realistic shadows. (6) NO digital art. NO empty sterile showroom feel. NO hyper-saturated impossible colors. The final image must look like a real photograph of a real ultimate gamer's bedroom that someone actually lives in.`,
                size: '1024x1024',
            }),
