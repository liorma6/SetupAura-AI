    ...
    try {
        ...
        const aiResponse = await Promise.race([
            openai.images.edit({
                model: 'gpt-image-1',
                image: imageFile,
                prompt: `You are an expert interior design photographer specializing in gaming setups. Your task is to edit this real room photo into the ultimate ${activeTheme}. STRICT RULES: (1) Extremely photorealistic interior design photography, 8K resolution quality. This must be completely indistinguishable from a real photograph — NOT a 3D render, NOT digital art, NOT a cartoon or illustration. (2) STRICTLY MAINTAIN ALL of the following elements exactly as they appear in the original photo: the desk, walls, floor, ceiling, windows, doors, and room layout. Do NOT alter the room's architecture or perspective. (3) REPLACE the existing chair with a realistic, high-end gaming chair in the style of a Secretlab Titan that fits the scene's real lighting conditions and casts proper shadows. (4) If there is a bed visible, upgrade the bedding to match the ${activeTheme} gaming theme with thematic covers and pillows — keep the bed frame exactly as it is. (5) Add realistic RGB LED lighting strips along desk edges and behind the monitor(s), along with premium gaming peripherals (mechanical keyboard, gaming mouse, headphone stand, controller). All added items must look like real consumer products with accurate textures and lighting. (6) Make the room look deeply lived-in and personalized — populate shelves and surfaces with action figures, collectibles, and game cases where it fits naturally. (7) Use natural, balanced ambient RGB lighting. Avoid washing the entire room in a single blinding neon colour. Keep lighting authentic and inviting. (8) NO digital art. NO empty sterile showroom feel. NO hyper-saturated impossible colours. The final image must look like a real photograph of a real ultimate gamer's room that someone actually lives in.`,
                size: '1024x1024',
            }),
