    ...
    try {
        ...
        const aiResponse = await Promise.race([
            openai.images.edit({
                model: 'gpt-image-1',
                image: imageFile,
                prompt: `You are an expert interior design photographer specializing in gaming setups. Your task is to edit this real room photo into the ultimate ${activeTheme}. STRICT RULES: (1) Extremely photorealistic interior design photography, 8K resolution quality. This must be completely indistinguishable from a real photograph. NO 3D renders, NO digital art, NO fantasy or cartoon styles. (2) STRICTLY MAINTAIN all structural elements exactly as they appear: walls, floor, ceiling, windows, doors, and room layout. Do NOT alter the architecture. (3) YOU MUST REPLACE the existing chair with a premium, high-end realistic gaming chair (e.g., Secretlab style) that fits the perspective and casts proper shadows. (4) YOU MUST UPGRADE any visible bedding to a modern gaming aesthetic with themed covers, keeping the original bed frame structure. DO NOT leave the old chair or plain bedding as is. (5) Add realistic RGB LED lighting strips along desk edges and behind the monitor(s). (6) Add premium gaming peripherals (mechanical keyboard, gaming mouse, headphone stand). (7) Make the room look richly lived-in by populating shelves and desks with high-quality, realistic collectible figures (such as One Piece characters or League of Legends champions) and cool tech gadgets. Every added item must look like a real physical product that exists in the real world. (8) Use natural, balanced ambient RGB lighting. The final image must look like a real photograph of an ultimate gamer's room.`,
                size: '1024x1024',
            }),
